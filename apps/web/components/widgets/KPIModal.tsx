    ...
    <AnimatePresence>
      {open ? (
        ...
        >
          ...
          />
          <motion.div
            className="widget-interactive relative z-[101] h-[100dvh] w-full overflow-y-auto rounded-none border border-white/10 bg-[#24283d] p-5 shadow-2xl sm:h-auto sm:max-h-[calc(100dvh-2rem)] sm:max-w-3xl sm:rounded-lg"
          ...
          >
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-[0.8fr_1.2fr]">
              <div className="rounded-lg border border-white/10 bg-[#2d3147] p-4">
                ...
                {comparisonSummary ? (
                  <div className="mt-4 rounded-lg bg-white/[0.04] p-3 text-sm font-bold text-slate-200">{comparisonSummary}</div>
                ) : null}
              </div>
              {chart}
            </div>
